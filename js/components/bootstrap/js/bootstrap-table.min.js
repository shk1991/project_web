...
$("body").on("click",".page-list .text",function(){
    var $parentSpan = $(this).closest("span");
    if(!$parentSpan.hasClass("open")){
        $parentSpan.addClass("open");
    }else{
...
$("body").on("click",function(e){
    var $pageTable = $(".bootstrap-page-table");
    $pageTable.hasClass("open") ? $(".bootstrap-page-table").removeClass("open") : "";
});